...
exports.makeArea = exports.getSentiment = exports.gatherPoints = exports.pathPalette = exports.resolveFrequency = exports.makeFullLyrics = void 0;
...
const getSentiment = async lyrics => sentiment.analyze(lyrics.join(' ')); // [{x: int, y: int}]
// This is a sum of the change in height between every point


exports.getSentiment = getSentiment;

const makeArea = dataArray => {
